...
public enum KeypadButton {
	...
	, SIGN("¡À",KeypadButtonCategory.OTHER)
	, SQRT("SQRT",KeypadButtonCategory.OTHER)
	, PERCENT("%",KeypadButtonCategory.OTHER)
	, CALCULATE("=",KeypadButtonCategory.RESULT)
	, DOUBLEZERO("00", KeypadButtonCategory.NUMBER)
	, DEL("DEL", KeypadButtonCategory.CLEAR)
	, CREDIT("CREDIT", KeypadButtonCategory.CREDIT)
	, CASH("CASH", KeypadButtonCategory.CASH)
	, OTHER("OTHER", KeypadButtonCategory.OTHERTRANC)
